//Implementation of various ECIES functionality required by RLPX.
...
pub struct ECIES {
    ...
    pub nonce: H256,
    pub shared_key: H256,
    pub auth_mess: Option<Bytes>,
    pub auth_received: Option<Bytes>,
}
...
impl ECIES {
    ...
    pub fn encrypt(&self, data_in: BytesMut, data_out: &mut BytesMut) -> Result<usize> {
        ...
        let total_size = u16::try_from(65 + 16 + data_in.len() + 32).expect("UNEXPECTED ERROR");
    ...
    pub fn decrypt<'a>(
        ...
        *read_bytes = payload_size + 2;
        ...
        self.auth_received = Some(Bytes::copy_from_slice(
